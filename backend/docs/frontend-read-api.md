...
지도와 상세 API가 제공하는 서비스 장소는 역사유적 `HS01`, 역사유물 `HS02`, 박물관 `VE070100`, 기념관 `VE070200`, 미술관·화랑 `VE070600`으로 한정한다. 종교성지·안보관광지·랜드마크와 행사·축제·여행코스·레포츠·숙박·쇼핑·음식점은 백엔드에서 제외하므로 프론트가 별도로 필터링할 필요가 없다.
